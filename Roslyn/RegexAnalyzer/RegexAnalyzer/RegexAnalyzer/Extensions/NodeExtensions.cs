...
using RegexAnalyzer.Helper;

namespace RegexAnalyzer.Extensions
{
    [DebuggerDisplay("nonUserAttributeRegex={" + nameof(NonUserAttributeRegex) + "}")]
    public static class NodeExtensions
    {
        ...
        public static Boolean HasGetter(this PropertyDeclarationSyntax property)
        {
            ...
            return property.AccessorList.Accessors.Any(t => t.IsKind(SyntaxKind.GetAccessorDeclaration));
        }
